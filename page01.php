...
<?php
	...
	echo "<a href = 'page01.php'>back</a>";
	}else{
		echo '<form method="get" action="page01.php">
	...
	<tr>
		...
		<input type="radio" name="n4" size="15" value="ITI">ITI
        <input type="radio" name="n4" size="15" value="INE">INE
        </td>
	</tr>
		</tr>
